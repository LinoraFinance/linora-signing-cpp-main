...
This library will allow them to integrate with linora and improve quality of liquidity on linora' order books.
This in turn will increase trading volume and transactions on linora, StarkNet and Ethereum networks.  
Average latencies of signing a linora order using different language libraries:
